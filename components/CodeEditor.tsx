...
export default function CodeEditor({
    ...
    // Handle editor changes and notify the parent
    const handleEditorChange = (value: string | undefined) => {
        const updatedCode = value || '';
        setCode(updatedCode);
        onCodeChange(updatedCode); // Notify the parent component of the updated code
    };
    ...
    const handleLanguageChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
        const selectedLanguage = e.target.value;
        setLanguage(selectedLanguage);
        // Update code with the boilerplate for the selected language
        const boilerplate = boilerplateCode[selectedLanguage] || '// No boilerplate available for this language.\n';
        setCode(boilerplate);
        onCodeChange(boilerplate); // Notify the parent of the boilerplate change
    };
